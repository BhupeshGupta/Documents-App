...
angular.module('starter')
    .controller('InvoiceFlowController', function (SettingsFactory, SessionService, $ionicPopup, $ionicModal, $scope, $state, $cordovaBarcodeScanner, getInvoiceMetaData, $cordovaCamera, $q, $http, FileFactory, $cordovaFile, InvoiceDocumentCaptureService, DocUpload, FileDataService) {
